...
import {Card, Col, Container, Row, SSRProvider} from "react-bootstrap";
                                ...
                                <Row xs={1} sm={3} className='gy-4'>
                                    <Col>
                                        ...
                                        <ul className='list-unstyled fs-sm'>
                                            <li><Link href='src/components/partials#' className='nav-link-light'>About
                                                us</Link></li>
                                            <li><Link href='src/components/partials#' className='nav-link-light'>News</Link>
                                            </li>
                                            <li><Link href='src/components/partials#'
                                                      className='nav-link-light'>Contacts</Link></li>
                                        </ul>
                                    </Col>
                                    <Col>
                                        <h3 className='h6 mb-2 pb-1 fs-base text-light'>For Job Seekers</h3>
                                        <ul className='list-unstyled fs-sm'>
                                            <li><Link href='src/components/partials#' className='nav-link-light'>Find
                                                job</Link></li>
                                            <li><Link href='src/components/partials#' className='nav-link-light'>Post a
                                                resume</Link></li>
                                            <li><Link href='src/components/partials#' className='nav-link-light'>Vacancy
                                                mailing</Link></li>
                                        </ul>
                                    </Col>
                                    <Col>
                                        ...
                                        <ul className='list-unstyled fs-sm'>
                                            ...
                                            <li><Link href='src/components/partials#' className='nav-link-light'>Post a
                                                job</Link></li>
                                            <li><Link href='src/components/partials#' className='nav-link-light'>Resume
                                                mailing</Link></li>
                                        </ul>
                                    </Col>
                                </Row>
                            ...
                            <Col md={6} xl={{offset: 1}}>
                                <div className='d-flex align-items-center'>
                                    <Card className='card-light w-100' style={{maxWidth: '526px'}}>
                                        <Card.Body className='p-4 p-xl-5 my-2 my-md-0'>
                                            <div style={{maxWidth: '380px'}}>
                                                ...
                                                <p className='fs-sm text-light opacity-70 mb-2 mb-lg-3'>Now finding the new
                                                    job just got even easier with our new app!</p>
                                                <div className='d-flex flex-column flex-sm-row ms-n3'>
                                                    <MarketButton href='#' market='apple' target='_blank'
                                                                  className='mt-3 ms-3'/>
                                                    <MarketButton href='#' market='google' target='_blank'
                                                                  className='mt-3 ms-3'/>
                                                </div>
                                            </div>
                                        </Card.Body>
                                    ...
                                    <div className='d-none d-xl-block ms-n4'>
                                        <ImageLoader priority src='/images/job-board/footer-mobile.svg' width={116}
                                                     height={233} alt='Mobile app'/>
                                    </div>
                                </div>
                            </Col>
                        </Row>
